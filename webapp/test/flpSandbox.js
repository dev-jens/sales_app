		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales app",
									"targetURL": "#beeduapsaleszsd040salesapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"beeduapsaleszsd040salesapp-display": {
								"semanticObject": "beeduapsaleszsd040salesapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.edu.ap.sales.zsd040salesapp",
									"url": sap.ui.require.toUrl("be/edu/ap/sales/zsd040salesapp")
								}
							}
						}
					}
